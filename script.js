...
pl2.addEventListener("mouseover", function changeImage2(event) {
	event.preventDefault();
	projectImage.style.backgroundImage =
		"linear-gradient( to right, rgba(0, 214, 255, 0.3) 0%, transparent 50%, transparent 100%), url(clock.png)";
	projectDescription.innerHTML =
...
pl3.addEventListener("mouseover", function changeImage3(event) {
	event.preventDefault();
	projectImage.style.backgroundImage =
		"linear-gradient( to right, rgba(0, 224, 255, 0.3) 0%, transparent 50%, transparent 100%), url(podcast.png)";
	projectDescription.innerHTML =
...
pl4.addEventListener("mouseover", function changeImage4(event) {
	event.preventDefault();
	projectImage.style.backgroundImage =
		"linear-gradient( to right, rgba(0, 234, 255, 0.2) 0%, transparent 50%, transparent 100%), url(recipe.png)";
	projectDescription.innerHTML =
...
pl5.addEventListener("mouseover", function changeImage5(event) {
	event.preventDefault();
	projectImage.style.backgroundImage =
		"linear-gradient( to right, rgba(0, 234, 255, 0.2) 0%, transparent 50%, transparent 100%), url(game.png)";
	projectDescription.innerHTML =
