...
let weatherApp =
	"WEATHER APP:<br/>I built this using JavaScript React. This has been one of my favorite projects to build as Iv'e particularly enjoyed building functional and interactive sites. To further improve this project, I'd like to use global states that allow the temperatures on the weekly forecast to be changeable to Fahrenheit. And I'd like to add graphs showing hourly data for precipitation and temperature. ";
let worldClock =
...
let recipeGenerator =
	"RECIPE GENERATOR:<br/>This was an exercise in AI prompting, and I really enjoyed the outcome of this site. Like the weather app, I went for a modern and simplistic dark mode design. I often find busy sites overwhelming and difficult to engage with - especially recipe pages. I enjoy building content focused and simplistic looking sites as they are the ones I enjoy interacting with. ";
let game =
	"A LITTLE ALIEN GAME: <br/>This is the first game Iv'e built and I thoroughly enjoyed it. Whilst I'm not aiming for a career in game development, I have already begun to continue this as a hobby. I plan to work on this game further, first by adding some chaotic elements, perhaps similar to Pacman, the chance to kill the enemy aliens for a set amount of time. I'd also like to add levels to the game and animate the characters.  ";
